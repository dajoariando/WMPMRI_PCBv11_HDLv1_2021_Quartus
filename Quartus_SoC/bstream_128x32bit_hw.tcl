...
# Thu Apr 14 13:42:04 EDT 2022
# DO NOT MODIFY


# 
# bstream_new "Bitstream Controller 128x32bit" v1.0
# David Ariando 2022.04.14.13:42:04
...
set_module_property NAME bstream_new
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property GROUP "Custom Logics"
set_module_property AUTHOR "David Ariando"
set_module_property DISPLAY_NAME "Bitstream Controller 128x32bit"
...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL NMR_bstrm_simp_mm_comp
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file NMR_bstrm_simp_cnt.sv SYSTEM_VERILOG PATH ../Quartus_NoSoC/HDL/NMR_bstrm_simp_cnt.sv
add_fileset_file NMR_bstrm_simp_dpath.sv SYSTEM_VERILOG PATH ../Quartus_NoSoC/HDL/NMR_bstrm_simp_dpath.sv
add_fileset_file NMR_bstrm_simp_mm_comp.sv SYSTEM_VERILOG PATH ../Quartus_NoSoC/HDL/NMR_bstrm_simp_mm_comp.sv TOP_LEVEL_FILE
add_fileset_file bstream_ram_128x32bit.qip OTHER PATH ../Quartus_NoSoC/HDL/Altera_IP/bstream_ram_128x32bit.qip
...
add_parameter SRAM_ADDR_WIDTH INTEGER 7 ""
set_parameter_property SRAM_ADDR_WIDTH DEFAULT_VALUE 7
set_parameter_property SRAM_ADDR_WIDTH DISPLAY_NAME SRAM_ADDR_WIDTH
set_parameter_property SRAM_ADDR_WIDTH TYPE INTEGER
set_parameter_property SRAM_ADDR_WIDTH ENABLED false
...
set_parameter_property SRAM_ADDR_WIDTH DESCRIPTION ""
set_parameter_property SRAM_ADDR_WIDTH HDL_PARAMETER true
add_parameter SRAM_DAT_WIDTH INTEGER 32 ""
set_parameter_property SRAM_DAT_WIDTH DEFAULT_VALUE 32
set_parameter_property SRAM_DAT_WIDTH DISPLAY_NAME SRAM_DAT_WIDTH
set_parameter_property SRAM_DAT_WIDTH WIDTH ""
...
set_parameter_property SRAM_DAT_WIDTH DESCRIPTION ""
set_parameter_property SRAM_DAT_WIDTH HDL_PARAMETER true
add_parameter MUX_WIDTH INTEGER 16
set_parameter_property MUX_WIDTH DEFAULT_VALUE 16
set_parameter_property MUX_WIDTH DISPLAY_NAME MUX_WIDTH
set_parameter_property MUX_WIDTH TYPE INTEGER
set_parameter_property MUX_WIDTH ENABLED false
set_parameter_property MUX_WIDTH UNITS None
set_parameter_property MUX_WIDTH ALLOWED_RANGES -2147483648:2147483647
set_parameter_property MUX_WIDTH HDL_PARAMETER true
